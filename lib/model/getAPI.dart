...
Future<List<LaneToTracks>> getAPILaneToTracks() async {
  var response = await http.get(Uri.parse(URL_LANE_TO_TRACKS));
...
Future<List<NodeOfLanes>> getAPINodeOfLanes() async {
  var response = await http.get(Uri.parse(URL_NODE_OF_LANES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<PosOfBuses>> getAPIPosOfBuses() async {
  var response = await http.get(Uri.parse(URL_POS_OF_BUSES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<UlsanBusLaneToTracks>> getAPIUlsanBusLaneToTracks() async {
  var response = await http.get(Uri.parse(URL_ULSAN_BUS_LANE_TO_TRACKS));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<UlsanBusTimeTables>> getAPIUlsanBusTimeTables() async {
  var response = await http.get(Uri.parse(URL_ULSAN_BUS_TIME_TABLES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<UlsanBusNodeToTracks>> getAPIUlsanBusNodeToTracks() async {
  var response = await http.get(Uri.parse(URL_ULSAN_BUS_NODE_TO_TRACKS));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<UlsanBusArrivalInfos>> getAPIUlsanBusArrivalInfos() async {
  var response = await http.get(Uri.parse(URL_ULSAN_BUS_ARRIVAL_INFOS));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<LaneAliases>> getAPILaneAliases() async {
  var response = await http.get(Uri.parse(URL_LANE_ALIASES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<PartOfLanes>> getAPIPartOfLanes() async {
  var response = await http.get(Uri.parse(URL_PART_OF_LANES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<MapToAliases>> getAPIMapToAliases() async {
  var response = await http.get(Uri.parse(URL_MAP_TO_ALIASES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<LandmarkAliases>> getAPILandmarkAliases() async {
  var response = await http.get(Uri.parse(URL_LANDMARK_ALIASES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<LandmarkNodes>> getAPILandmarkNodes() async {
  var response = await http.get(Uri.parse(URL_LANDMARK_NODES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
...
Future<List<LandmarkOfLanes>> getAPILandmarkOfLanes() async {
  var response = await http.get(Uri.parse(URL_LANDMARK_OF_LANES));
  var statusCode = response.statusCode;
  var responseHeaders = response.headers;
  String jsonString = utf8.decode(response.bodyBytes);
